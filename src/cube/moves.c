...
/*   Updated: 2023/05/19 11:09:10 by vjean            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (data->map->map[(int)data->ray->pos_Y][(int)(data->ray->pos_X + data->ray->ray_dirX * data->ray->move_speed)] == '.')
		data->ray->pos_X += data->ray->ray_dirX * data->ray->move_speed;
	if (data->map->map[(int)(data->ray->pos_Y + data->ray->ray_dirY * data->ray->move_speed)][(int)data->ray->pos_X] == '.')
		data->ray->pos_Y += data->ray->ray_dirY * data->ray->move_speed;
}
